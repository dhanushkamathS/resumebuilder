 ...
 const nextPage =()=>{
  ...
  return (
    ...
    <CurrentPosition value={"personal details"}/>
      <h1 className=' text-5xl text-center text-white'>Personal Detail</h1>
        <div className='flex justify-end mx-[20%]'>    
            <button onClick={nextPage} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Next</button>
        </div>
...
const PersonalDetailInput = ({formData,setFormData}) =>{
  ...
  return(
       <div className='dark:bg-gray-900 py-[7%]'>
